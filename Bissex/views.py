...
def Bissex_history(request):
    ...
    for obj in Bissex_annee:
        result_annee[(obj.command_date).strftime("%d/%m/%Y %H:%M:%S")] = [obj.command_type], [obj.command_entry], [obj.command_result], [obj.command_error]
    for obj in Bissex_range:
        result_range[(obj.command_date).strftime("%d/%m/%Y %H:%M:%S")] = [obj.command_type], [obj.command_entry], [obj.command_result], [obj.command_error]
